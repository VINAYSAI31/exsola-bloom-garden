        ...
        <div className="space-y-8">
          <div className="space-y-4">
            <div className="inline-flex items-center px-4 py-2 bg-green-100 text-green-800 rounded-full text-sm font-semibold">
              ...
              Science-Backed Premium Mushrooms
            </div>
            ...
            <p className="text-xl text-gray-600 max-w-lg">
              Revolutionary mushroom extracts, powders, and grow kits backed by cutting-edge research. 
              Experience the future of wellness with EXORA Labs.
            </p>
          </div>
          
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="bg-green-800 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-green-900 transition-all duration-300 transform hover:scale-105 flex items-center justify-center group">
              Explore Products
